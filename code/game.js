...
//Here is a simple constructor for Vector. Every instance created with this constructor will have this object as its prototype.

//A vector type - Write a constructor Vector that represents a vector in two-dimensional space. It takes x and y parameters (numbers), which it should save to properties of the same name.
...
//add a "plus" method to Vectors created with the Vector constructor,
  ...
  function handler(event) {
    ...
    if (codes.hasOwnProperty(event.keyCode)) {
      ...
      // This stops the event from continuing to be processed.
                  ...
                  //prevents the key that was pressed down from interacting with the browser
...
function addTable() {     
    ...
    var table = document.createElement('TABLE');
                ...
                //set the border to 0 to make it look clean          

    table.border='0';

                //set a class attribute on the table
    ...
    for (var i=0; i<11; i++){
       ...
       for (var j=0; j<5; j++){
           ...
           td.width='100';
                                   ...
                                   //make blank cells as place holder

           td.appendChild(document.createTextNode(""));

           tr.appendChild(td);

                //find the middle right Cell to write the start message

                        if(i==5 && j==0)

                                   {

                                        console.log("Press Space Bar key to start the game!");

                                        td.appendChild(document.createTextNode(" -> Press Space Bar key to start the game!!!"));
...
function runGame(plans, Display) {
  ...
  function startLevel(n) {
                ...
                //Start game message display

                //since game is now loading we intercept it to show the start message

                if(n==0){

                                console.log("Start Level set to = 0 ");

                                //Draw my table function to hold the start message

                                                addTable();

                                //variable to track the number to time the Spacebar was pressed

                                var SpacebarKeyPressCount = 0;

                               

                                // this function will execute when the Spacebar is Press for the 1st time ONLY

                                function myKeyPressFunction(event) {

                                                //check if the Spacebar Key was press (ASCII key code 32) and that its was the first time pressed

                                                if (event.charCode == "32" && SpacebarKeyPressCount < 1) {

                                                                //document.getElementById("myTableBackgroundID").style.backgroundColor = "red";

                                                                //alert("The 'SPACEBAR' key was pressed.");

                                                                //hide the start game table message

                                                                document.getElementById("myTableBackgroundID").style.display = "none";

                                                                //Increment the key press count

                                                                SpacebarKeyPressCount++;                                                                       

                                                                //call the wrapper function to continue loading the game levels

                                                                callingRunLevelFunction();
                                ...
                                //add a key press event listener on the entire document object

                                document.addEventListener("keypress", myKeyPressFunction, false);

                }

                //this is not the start of the game so don't wait for a any key to be pressed. load the next level
...
//START Wrapper for runLevel function

                function callingRunLevelFunction(){

                                // Create a new level using the nth element of array plans

                                // Pass in a reference to Display function, DOMDisplay (in index.html). the entire page 
                                ...
                                runLevel(new Level(plans[n]), Display, function(status) {
                                  ...
                                  if (status == "lost")

                                                {
                                                                ...
                                                                //START Write game status message to console
...

                                                {
                                                                ...
                                                                //message box show the current level number (n+1) since array starts at 0. And next level (n+2) to increment to next level

                                                                alert("Congratulations! You have passed Level " + (n + 1) + ". Click OK to start level " + (n + 2) + "!");
...

                                  {
                                      ...
                                      console.log("You win!");
                                       ...
                                       alert("Congratulations! You beat the game :o)");
  ...
  //Call the startLevel function and set the starting level value to 0
